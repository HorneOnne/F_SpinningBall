...
namespace SpinningBall
{
    public class SoundManager : MonoBehaviour
    {
        ...
        public void Initialized()
        {
            ...
            _soundTimerDictionary[SoundType.Turn] = 0.0f;
            _soundTimerDictionary[SoundType.Destroyed] = 0.0f;
            ...
            _soundTimerDictionary[SoundType.Shoot] = 0.0f;
        }
